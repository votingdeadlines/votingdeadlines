...
const statusTrimmedPath = resolve(`${root}/${VOTEAMERICA_REG_STATUS_TRIMMED_HTML_PATH}`)

readParseAndWriteHtml(regRawPath, VOTEAMERICA_REG_TABLE_SELECTOR, regTrimmedPath)
readParseAndWriteHtml(statusRawPath, VOTEAMERICA_REG_STATUS_TABLE_SELECTOR, statusTrimmedPath)
